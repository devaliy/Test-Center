...
<nav class="navbar navbar-expand-lg navbar-light bg-danger">
  <a class="navbar-brand" href="<?=BASE_URL?>staff/dashboard">Homepage</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <!-- <li class="nav-item active">
        <a class="nav-link  text-light" href="staff/dashboard">CBT Dashboard <span class="sr-only">(current)</span></a>
      </li> -->
     
   
      <li class="nav-item text-light">
        <a class="nav-link  text-light" href="staff/test">Manage Test</a>
      </li>
      <li class="nav-item text-light">
        <a class="nav-link  text-light" href="staff/schedule">Schedule Test</a>
      </li>
    
      <li class="nav-item text-light">
        <a class="nav-link  text-light" href="https://ekosuccesscloud.com/learn/index.php">Eko Success Cloud</a>
      </li>
