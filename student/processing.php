...
if(isset($_POST['option_id'])){
    ...
    if(isset($_POST['test_id'])){
            ...
            if(!empty($check_option)){
                ...
                $create_marking = $getFromExam->create('marking_up', array('student_id'=>$student_id, 'test_id'=>$exam_id, 'round'=>$round, 'question_id'=>$question_id,'option_id'=>$option_id, 'mark'=>$mark_opt->is_correct));
